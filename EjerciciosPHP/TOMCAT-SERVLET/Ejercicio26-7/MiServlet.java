...
while (misresultados.next()) {
        salida.println(
            ...
            "<input type='text' name='IdProducto' value='" +misresultados.getInt("IdProducto")+"' hidden>"+
...
salida.println(
    ...
    salida.println(
    "<form ACTION='http://localhost:8080/Proyecto1/vendedor' method='GET'>"+
    "<input type='text' name='form' value='Verpedidos' hidden>"+
    "<input TYPE='SUBMIT' value='VerPedidos'>"+
    "</form>"
    );
