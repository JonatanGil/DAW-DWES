...
double suma= 0;
    ...
    salida.println(IdProductosArray.get(0)+"<br>");
    salida.println(IdProductosArray);
...
for (int i = 0; i < IdProductosArray.size(); i++) {
            ...
            while (misresultados.next()) {
                ...
                "</TR>");
                suma += misresultados.getDouble("precio");
            }
    ...
    salida.println(
        ...
        "<input type='"+suma+"' name='total' hidden>"+
        ...
        salida.println("<br>PRECIO TOTAL="+(IdProductosArray.size()+2)+"<br>");
        salida.println(Double.parseDouble(peticion.getParameter("total")));
        salida.println(Double.parseDouble(peticion.getParameter("total")+IdProductosArray.size()+2));
