...
<body>
  ...
  <?php
    ...
    define("NumMin", PHP_INT_MIN);
    echo 'El numero menor minimo es: '.NumMin.'<br>';
   
    
    define("NumMax", PHP_INT_MAX);
    echo 'El numero menor maximo es: '.NumMin.'<br>';

    define("Size", PHP_INT_SIZE);
    echo Size.'<br>';
    ...
    echo PEAR_EXTENSION_DIR.'<br>';
    echo PHP_EXTENSION_DIR.'<br>';
    echo PHP_PREFIX.'<br>';
    echo PHP_BINARY.'<br>';
    echo PHP_DATADIR.'<br>';
    echo PHP_MANDIR.'<br>';
    echo PHP_SYSCONFDIR.'<br>';
    echo PHP_LOCALSTATEDIR.'<br>';
    echo PHP_CONFIG_FILE_PATH.'<br>';
    echo PHP_CONFIG_FILE_SCAN_DIR.'<br>';
    echo PHP_SHLIB_SUFFIX.'<br>';
    echo PHP_FD_SETSIZE.'<br>';
    echo E_ERROR.'<br>';
    echo E_WARNING.'<br>';
    echo E_PARSE.'<br>';
    echo E_NOTICE.'<br>';
